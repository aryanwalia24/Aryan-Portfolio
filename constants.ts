import { PersonalInfo, Experience, Project, Education, SkillCategory, CodingProfile } from './types';
...
export const summary = "Software Engineer with 1+ year of experience in full-stack development, microservices, and MLOps. Building production services with FastAPI, Spring Boot, and LLM integrations at Gracenote (Nielsen). Proficient in AWS cloud infrastructure, Kubernetes, Docker, and modern observability tooling (OpenTelemetry, Grafana, Prometheus). Experienced in designing agentic AI workflows using MCP servers, migrating legacy systems with zero-downtime database migrations, and managing end-to-end CI/CD pipelines. Strong foundation in system design, cloud-native architecture, and DevOps.";
...
export const projects: Project[] = [
  {
    ...
    period: "2025",
    description: "Developed a robust backend system with CI/CD pipeline flow and gateway service for efficient deployment and traffic management. Integrated comprehensive observability and metrics (business-driven and application-driven) to facilitate data-informed decision-making, in close collaboration with product teams.",
    tech: ["Spring Boot", "CI/CD", "OpenTelemetry", "Microservices"]
  },
  {
    name: "LLM-Powered Service",
    period: "2025",
    description: "Built FastAPI services integrating LLM models for metadata enrichment workflows, processing large-scale data. Designed agentic AI workflows for automated content classification and enrichment pipelines.",
  ...
  },
  {
    ...
    description: "Developed a fully functional Texas Hold'em Poker game in C, utilizing bitwise operations for efficient card data representation. Implemented modular code design including player management, game logic, and hand evaluation, compiled into a reusable static library.",
...
export const skills: SkillCategory[] = [
  ...
  {
    category: "Full-Stack",
    items: ["React.js", "Node.js", "Spring Boot", "FastAPI", "Tailwind CSS", "MongoDB"]
  },
  {
    category: "Cloud & DevOps",
    items: ["AWS (EC2, S3, RDS, CloudWatch)", "Terraform", "Kubernetes", "Docker", "CI/CD", "Linux", "Infrastructure as Code"]
  },
  {
    category: "Databases",
  ...
  {
    category: "AI/ML",
    items: ["Generative AI", "Agentic AI Workflows", "MCP Servers", "LLM Integration"]
  },
  {
    category: "Tools & Observability",
    items: ["Git", "GitHub", "GitLab", "Grafana", "Prometheus", "OpenTelemetry", "Rancher", "JIRA", "Postman", "Vercel"]
  },
  {
    category: "Concepts",
    items: ["Microservices", "System Design", "HLD", "REST APIs", "Observability", "SDLC", "Incident Management", "SOLID Principles", "OOP"]
  }
];
